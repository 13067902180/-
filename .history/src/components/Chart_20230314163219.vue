...
export default {
    ...
    ChangeChart(value) {
      switch (value) {
        case 1:
          ...
          console.log(this.$store.state.home.list3);
          break;
        case 2:
          console.log(this.$store.state.home.list4);
          console.log(this.list);
          list: this.$store.state.home.list4;
          console.log(this);
          break;
        case 3:
  ...
  mounted() {
    ...
    this.list`${this.radio}||3`.forEach((item, index) => {
      if (item.title) {
